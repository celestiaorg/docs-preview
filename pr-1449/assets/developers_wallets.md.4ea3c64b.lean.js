...
`),j,n(`
`),G,n(`
`),O])])]),s("div",W,[X,H,s("pre",Y,[s("code",null,[J,n(`
`),Q,n(`
`),z,n(`
...
`),Ws,n(`
`),s("span",Xs,[s("span",Hs,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
