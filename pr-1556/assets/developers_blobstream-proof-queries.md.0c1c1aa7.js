...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">  }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div><blockquote><p><strong><em>NOTE:</em></strong> These values are base64 encoded. For these to be usable with the solidity smart contract, they need to be converted to <code>bytes32</code>. Check the next section for more information.</p></blockquote><h4 id="golang-query" tabindex="-1">Golang query <a class="header-anchor" href="#golang-query" aria-label="Permalink to &quot;Golang query&quot;">​</a></h4><p>The endpoint can also be queried using the golang client:</p><div style="overflow-y:auto;max-height:400px;"><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div><h3 id="full-example-of-proving-that-a-celestia-block-was-committed-to-by-blobstream-x-contract" tabindex="-1">Full example of proving that a Celestia block was committed to by Blobstream X contract <a class="header-anchor" href="#full-example-of-proving-that-a-celestia-block-was-committed-to-by-blobstream-x-contract" aria-label="Permalink to &quot;Full example of proving that a Celestia block was committed to by Blobstream X contract&quot;">​</a></h3><div style="overflow-y:auto;max-height:400px;"><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> (</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">context</span><span style="color:#9ECBFF;">&quot;</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">fmt</span><span style="color:#9ECBFF;">&quot;</span></span>
...
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#79B8FF;">copy</span><span style="color:#E1E4E8;">(id[:], innerNode[</span><span style="color:#79B8FF;">1</span><span style="color:#E1E4E8;">:</span><span style="color:#79B8FF;">29</span><span style="color:#E1E4E8;">])</span></span>
...
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#F97583;">var</span><span style="color:#E1E4E8;"> id [</span><span style="color:#79B8FF;">28</span><span style="color:#E1E4E8;">]</span><span style="color:#F97583;">byte</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#79B8FF;">copy</span><span style="color:#E1E4E8;">(id[:], innerNode[</span><span style="color:#79B8FF;">30</span><span style="color:#E1E4E8;">:</span><span style="color:#79B8FF;">58</span><span style="color:#E1E4E8;">])</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#F97583;">return</span><span style="color:#E1E4E8;"> </span><span style="color:#F97583;">&amp;</span><span style="color:#E1E4E8;">client.Namespace{</span></span>
<span class="line"><span style="color:#E1E4E8;">		Version: [</span><span style="color:#79B8FF;">1</span><span style="color:#E1E4E8;">]</span><span style="color:#F97583;">byte</span><span style="color:#E1E4E8;">{version},</span></span>
<span class="line"><span style="color:#E1E4E8;">		Id:      id,</span></span>
<span class="line"><span style="color:#E1E4E8;">	}</span></span>
...
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#79B8FF;">copy</span><span style="color:#E1E4E8;">(digest[:], node[</span><span style="color:#79B8FF;">58</span><span style="color:#E1E4E8;">:])</span></span>
...
<span class="line"><span style="color:#24292E;">	</span><span style="color:#005CC5;">copy</span><span style="color:#24292E;">(id[:], innerNode[</span><span style="color:#005CC5;">1</span><span style="color:#24292E;">:</span><span style="color:#005CC5;">29</span><span style="color:#24292E;">])</span></span>
...
<span class="line"><span style="color:#24292E;">	</span><span style="color:#D73A49;">var</span><span style="color:#24292E;"> id [</span><span style="color:#005CC5;">28</span><span style="color:#24292E;">]</span><span style="color:#D73A49;">byte</span></span>
<span class="line"><span style="color:#24292E;">	</span><span style="color:#005CC5;">copy</span><span style="color:#24292E;">(id[:], innerNode[</span><span style="color:#005CC5;">30</span><span style="color:#24292E;">:</span><span style="color:#005CC5;">58</span><span style="color:#24292E;">])</span></span>
<span class="line"><span style="color:#24292E;">	</span><span style="color:#D73A49;">return</span><span style="color:#24292E;"> </span><span style="color:#D73A49;">&amp;</span><span style="color:#24292E;">client.Namespace{</span></span>
<span class="line"><span style="color:#24292E;">		Version: [</span><span style="color:#005CC5;">1</span><span style="color:#24292E;">]</span><span style="color:#D73A49;">byte</span><span style="color:#24292E;">{version},</span></span>
<span class="line"><span style="color:#24292E;">		Id:      id,</span></span>
<span class="line"><span style="color:#24292E;">	}</span></span>
...
<span class="line"><span style="color:#24292E;">	</span><span style="color:#005CC5;">copy</span><span style="color:#24292E;">(digest[:], node[</span><span style="color:#005CC5;">58</span><span style="color:#24292E;">:])</span></span>
...
<span class="line"><span style="color:#E1E4E8;">			</span><span style="color:#79B8FF;">copy</span><span style="color:#E1E4E8;">(bzSideNode[:], sideNode)</span></span>
...
<span class="line"><span style="color:#E1E4E8;">		}</span></span>
<span class="line"><span style="color:#E1E4E8;">	}</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#F97583;">return</span><span style="color:#E1E4E8;"> rowProofs</span></span>
...
<span class="line"><span style="color:#24292E;">			</span><span style="color:#005CC5;">copy</span><span style="color:#24292E;">(bzSideNode[:], sideNode)</span></span>
...
<span class="line"><span style="color:#24292E;">		}</span></span>
<span class="line"><span style="color:#24292E;">	}</span></span>
<span class="line"><span style="color:#24292E;">	</span><span style="color:#D73A49;">return</span><span style="color:#24292E;"> rowProofs</span></span>
...
<span class="line"><span style="color:#24292E;">	}</span></span></code></pre></div></div><h3 id="listening-for-new-data-commitments" tabindex="-1">Listening for new data commitments <a class="header-anchor" href="#listening-for-new-data-commitments" aria-label="Permalink to &quot;Listening for new data commitments&quot;">​</a></h3><p>For listening for new <code>BlobstreamXDataCommitmentStored</code> events, sequencers can use the <code>WatchDataCommitmentStored</code> as follows:</p><div style="overflow-y:auto;max-height:400px;"><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#E1E4E8;">    ethClient, err </span><span style="color:#F97583;">:=</span><span style="color:#E1E4E8;"> ethclient.</span><span style="color:#79B8FF;">Dial</span><span style="color:#E1E4E8;">(</span><span style="color:#9ECBFF;">&quot;evm_rpc&quot;</span><span style="color:#E1E4E8;">)</span></span>
<span class="line"><span style="color:#E1E4E8;">    </span><span style="color:#F97583;">if</span><span style="color:#E1E4E8;"> err </span><span style="color:#F97583;">!=</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">nil</span><span style="color:#E1E4E8;"> {</span></span>
<span class="line"><span style="color:#E1E4E8;">	    </span><span style="color:#F97583;">return</span><span style="color:#E1E4E8;"> err</span></span>
<span class="line"><span style="color:#E1E4E8;">    }</span></span>
<span class="line"><span style="color:#E1E4E8;">    </span><span style="color:#F97583;">defer</span><span style="color:#E1E4E8;"> ethClient.</span><span style="color:#79B8FF;">Close</span><span style="color:#E1E4E8;">()</span></span>
...
<span class="line"><span style="color:#24292E;">	    }</span></span>
<span class="line"><span style="color:#24292E;">    }</span></span></code></pre></div></div><p>Then, new proofs can be created as documented above using the new data commitments contained in the received events.</p><h3 id="example-rollup-that-uses-the-daverifier" tabindex="-1">Example rollup that uses the DAVerifier <a class="header-anchor" href="#example-rollup-that-uses-the-daverifier" aria-label="Permalink to &quot;Example rollup that uses the DAVerifier&quot;">​</a></h3><p>An example rollup that uses the DAVerifier can be as simple as:</p><div style="overflow-y:auto;max-height:400px;"><div class="language-solidity vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">solidity</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">pragma</span><span style="color:#E1E4E8;"> </span><span style="color:#85E89D;">solidity</span><span style="color:#E1E4E8;"> </span><span style="color:#79B8FF;">^0.8.22</span><span style="color:#E1E4E8;">;</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#24292E;">    }</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div><p>Then, you can submit the fraud proof using golang as follows:</p><div style="overflow-y:auto;max-height:400px;"><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">main</span></span>
<span class="line"></span>
<span class="line"><span style="color:#F97583;">import</span><span style="color:#E1E4E8;"> (</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">context</span><span style="color:#9ECBFF;">&quot;</span></span>
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#9ECBFF;">&quot;</span><span style="color:#B392F0;">fmt</span><span style="color:#9ECBFF;">&quot;</span></span>
...
<span class="line"><span style="color:#E1E4E8;">	</span><span style="color:#79B8FF;">copy</span><span style="color:#E1E4E8;">(blockDataRoot[:], dataRoot)</span></span>
...
<span class="line"><span style="color:#24292E;">	</span><span style="color:#005CC5;">copy</span><span style="color:#24292E;">(blockDataRoot[:], dataRoot)</span></span>
...
<span class="line"><span style="color:#24292E;">		Id:      id,</span></span>
<span class="line"><span style="color:#24292E;">	}</span></span>
<span class="line"><span style="color:#24292E;">}</span></span></code></pre></div></div><p>For the step (2), check the <a href="https://github.com/celestiaorg/blobstream-contracts/blob/master/docs/inclusion-proofs.md" target="_blank" rel="noreferrer">rollup inclusion proofs documentation</a> for more information.</p><h2 id="conclusion" tabindex="-1">Conclusion <a class="header-anchor" href="#conclusion" aria-label="Permalink to &quot;Conclusion&quot;">​</a></h2><p>After creating all the proofs, and verifying them:</p><ol><li>Verify inclusion proof of the transaction to Celestia data root</li><li>Prove that the data root tuple is committed to by the Blobstream X smart contract</li></ol><p>We can be sure that the data was published to Celestia, and then rollups can proceed with their normal fraud proving mechanism.</p><div class="tip custom-block"><p class="custom-block-title">NOTE</p><p>The above proof constructions are implemented in Solidity, and may require different approaches in other programming languages.</p></div>`,116),c=[t];function r(E,y,i,d,F,h){return n(),a("div",null,c)}const f=s(e,[["render",r]]);export{m as __pageData,f as default};
