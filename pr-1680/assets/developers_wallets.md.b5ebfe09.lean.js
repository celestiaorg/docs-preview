...
`),G,n(`
`),j,n(`
`),O])])]),s("div",H,[Q,W,s("pre",J,[s("code",null,[Y,n(`
`),z,n(`
`),X,n(`
...
`),Ss,n(`
`),s("span",vs,[s("span",Rs,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",Ns,[s("span",fs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),xs,n(`
`),Vs,n(`
