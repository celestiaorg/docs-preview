...
`),j,n(`
`),H,n(`
`),O])])]),s("div",G,[Q,W,s("pre",J,[s("code",null,[Z,n(`
`),Y,n(`
`),z,n(`
...
`),Ls,n(`
`),js,n(`
`),s("span",Hs,[s("span",Os,"  chainId: '"+l(a.constants.arabicaChainId)+"',",1)]),n(`
`),Gs,n(`
