...
`),q])])]),I,s("table",null,[x,s("tbody",null,[s("tr",null,[P,V,s("td",null,o(t(n).mainnetChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mainnetChainId),1)])]),s("tr",null,[R,D,s("td",null,o(t(n).mochaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mochaChainId),1)])]),s("tr",null,[N,L,s("td",null,o(t(n).arabicaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).arabicaChainId),1)])])])]),O,s("div",M,[j,W,s("pre",z,[s("code",null,[H,a(`
`),U,a(`
`),$,a(`
`),Y,a(`
`),K,a(`
`),X,a(`
`),G,a(`
`),s("span",Q,[J,s("span",Z,"--chain-id="+o(t(n).mochaChainId),1),ss,as]),a(`
`),es,a(`
`),ns,a(`
`),os,a(`
`),ts,a(`
