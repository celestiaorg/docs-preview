...
`),q])])]),x,s("table",null,[I,s("tbody",null,[s("tr",null,[P,V,s("td",null,o(t(n).mainnetChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mainnetChainId),1)])]),s("tr",null,[R,D,s("td",null,o(t(n).mochaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).mochaChainId),1)])]),s("tr",null,[N,L,s("td",null,o(t(n).arabicaChainId),1),s("td",null,[s("code",null,"--chain-id "+o(t(n).arabicaChainId),1)])])])]),O,s("div",M,[j,U,s("pre",z,[s("code",null,[W,a(`
`),H,a(`
`),$,a(`
`),Y,a(`
`),G,a(`
`),K,a(`
`),Q,a(`
`),s("span",Z,[J,s("span",X,"--chain-id="+o(t(n).mochaChainId),1),ss,as]),a(`
`),es,a(`
`),ns,a(`
`),os,a(`
`),ts,a(`
