...
`),L,a(`
`),K,a(`
`),H])]),s("pre",J,[s("code",null,[Q,a(`
`),s("span",Z,[j,s("span",X,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),z,a(`
`),$,a(`
...
`),Ys,a(`
`),Ws,a(`
`),s("span",Ls,[Ks,s("span",Hs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Js,a(`
`),Qs])])]),Zs,s("div",js,[Xs,zs,s("pre",$s,[s("code",null,[sa,a(`
