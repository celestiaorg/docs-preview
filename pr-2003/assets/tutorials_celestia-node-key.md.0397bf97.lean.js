...
`),s("span",G,[Y,s("span",K,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),W,a(`
`),L,a(`
...
`),Ys,a(`
`),Ks,a(`
`),s("span",Ws,[Ls,s("span",Zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Xs,a(`
`),js])])]),Qs,s("div",Hs,[zs,Js,s("pre",$s,[s("code",null,[sa,a(`
