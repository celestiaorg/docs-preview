...
`),Gs,a(`
`),Ks,a(`
`),s("span",Xs,[Ws,s("span",Ls,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),zs])])]),Js,s("div",Qs,[js,Hs,s("pre",$s,[s("code",null,[sa,a(`
