...
`),s("span",K,[Y,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),L,a(`
`),J,a(`
`),W])]),s("pre",Z,[s("code",null,[j,a(`
`),s("span",Q,[H,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Ys,a(`
`),Gs,a(`
`),s("span",Ls,[Js,s("span",Ws,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),js])])]),Qs,s("div",Hs,[zs,Xs,s("pre",$s,[s("code",null,[sa,a(`
