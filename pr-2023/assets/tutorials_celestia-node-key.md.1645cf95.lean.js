...
`),P,a(`
`),V,a(`
`),q])])]),R,s("div",x,[N,M,s("pre",O,[s("code",null,[U,a(`
`),s("span",Y,[W,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),J,a(`
`),H,a(`
`),L])]),s("pre",K,[s("code",null,[Q,a(`
`),s("span",X,[Z,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),j,a(`
`),$,a(`
...
`),Ws,a(`
`),Gs,a(`
`),s("span",Js,[Hs,s("span",Ls,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Ks,a(`
`),Qs])])]),Xs,s("div",Zs,[zs,js,s("pre",$s,[s("code",null,[sa,a(`
