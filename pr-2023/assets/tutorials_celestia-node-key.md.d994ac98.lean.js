...
`),P,a(`
`),q,a(`
`),V])])]),x,s("div",R,[N,M,s("pre",O,[s("code",null,[U,a(`
`),s("span",Y,[W,s("span",L,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),K,a(`
`),Z])]),s("pre",z,[s("code",null,[Q,a(`
`),s("span",X,[J,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Ws,a(`
`),Ls,a(`
`),s("span",Gs,[Ks,s("span",Zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),zs,a(`
`),Qs])])]),Xs,s("div",Js,[js,Hs,s("pre",$s,[s("code",null,[sa,a(`
