...
`),K,a(`
`),z,a(`
`),J])]),s("pre",L,[s("code",null,[Q,a(`
`),s("span",Z,[j,s("span",H,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Gs,a(`
`),Ws,a(`
`),s("span",Ks,[zs,s("span",Js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Ls,a(`
`),Qs])])]),Zs,s("div",js,[Hs,Xs,s("pre",$s,[s("code",null,[sa,a(`
