...
`),Gs,a(`
`),Ls,a(`
`),s("span",Ws,[Zs,s("span",js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Ks,a(`
`),Qs])])]),Xs,s("div",zs,[Js,Hs,s("pre",$s,[s("code",null,[sa,a(`
