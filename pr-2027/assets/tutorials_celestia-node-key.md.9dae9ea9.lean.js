...
`),Gs,a(`
`),Ls,a(`
`),s("span",Ks,[Ws,s("span",Xs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Js,a(`
`),Qs])])]),zs,s("div",Zs,[js,Hs,s("pre",$s,[s("code",null,[sa,a(`
