...
`),Z,a(`
`),K,a(`
`),W])]),s("pre",j,[s("code",null,[Q,a(`
`),s("span",H,[X,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),J,a(`
`),$,a(`
...
`),Gs,a(`
`),Ls,a(`
`),s("span",Zs,[Ks,s("span",Ws,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),js,a(`
`),Qs])])]),Hs,s("div",Xs,[zs,Js,s("pre",$s,[s("code",null,[sa,a(`
