...
`),W,a(`
`),J,a(`
`),L])]),s("pre",X,[s("code",null,[z,a(`
`),s("span",H,[Z,s("span",Q,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),j,a(`
`),$,a(`
...
`),Gs,a(`
`),Ks,a(`
`),s("span",Ws,[Js,s("span",Ls,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Xs,a(`
`),zs])])]),Hs,s("div",Zs,[Qs,js,s("pre",$s,[s("code",null,[sa,a(`
