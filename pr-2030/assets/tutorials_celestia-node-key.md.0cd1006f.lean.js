...
`),s("span",j,[z,s("span",J,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),Q,a(`
`),$,a(`
...
`),Gs,a(`
`),Ws,a(`
`),s("span",Ls,[Hs,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),Xs])])]),js,s("div",zs,[Js,Qs,s("pre",$s,[s("code",null,[sa,a(`
