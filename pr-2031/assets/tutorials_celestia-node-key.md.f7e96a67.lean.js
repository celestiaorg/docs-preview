...
`),P,a(`
`),V,a(`
`),q])])]),x,s("div",R,[N,M,s("pre",O,[s("code",null,[U,a(`
`),s("span",K,[Y,s("span",L,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),W,a(`
`),G,a(`
`),j])]),s("pre",Q,[s("code",null,[H,a(`
...
`),Ys,a(`
`),Ls,a(`
`),s("span",Ws,[Gs,s("span",js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Qs,a(`
`),Hs])])]),Zs,s("div",zs,[Js,Xs,s("pre",$s,[s("code",null,[sa,a(`
