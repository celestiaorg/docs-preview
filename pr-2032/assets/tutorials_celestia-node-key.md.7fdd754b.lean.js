...
`),W,a(`
`),K,a(`
`),Z])]),s("pre",j,[s("code",null,[Q,a(`
`),s("span",X,[H,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),J,a(`
`),$,a(`
...
`),Ys,a(`
`),Gs,a(`
`),s("span",Ws,[Ks,s("span",Zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),js,a(`
`),Qs])])]),Xs,s("div",Hs,[zs,Js,s("pre",$s,[s("code",null,[sa,a(`
