...
`),W,a(`
`),L,a(`
`),J])]),s("pre",Z,[s("code",null,[j,a(`
`),s("span",z,[X,s("span",Q,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Gs,a(`
`),Ks,a(`
`),s("span",Ws,[Ls,s("span",Js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),js])])]),zs,s("div",Xs,[Qs,Hs,s("pre",$s,[s("code",null,[sa,a(`
