...
`),z,a(`
`),G,a(`
`),K])]),s("pre",J,[s("code",null,[X,a(`
`),s("span",Z,[Q,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Ws,a(`
`),Ls,a(`
`),s("span",zs,[Gs,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Js,a(`
`),Xs])])]),Zs,s("div",Qs,[js,Hs,s("pre",$s,[s("code",null,[sa,a(`
