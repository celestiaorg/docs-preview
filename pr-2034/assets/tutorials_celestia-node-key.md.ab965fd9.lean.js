...
`),Gs,a(`
`),Ls,a(`
`),s("span",Ws,[js,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Qs,a(`
`),Zs])])]),Hs,s("div",zs,[Js,Xs,s("pre",$s,[s("code",null,[sa,a(`
