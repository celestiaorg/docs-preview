...
`),L,a(`
`),Q,a(`
`),K])]),s("pre",Z,[s("code",null,[z,a(`
`),s("span",j,[X,s("span",J,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Ws,a(`
`),Gs,a(`
`),s("span",Ls,[Qs,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),zs])])]),js,s("div",Xs,[Js,Hs,s("pre",$s,[s("code",null,[sa,a(`
