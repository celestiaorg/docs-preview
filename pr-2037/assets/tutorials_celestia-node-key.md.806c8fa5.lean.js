...
`),Gs,a(`
`),Ks,a(`
`),s("span",Ls,[Ws,s("span",Zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Xs,a(`
`),js])])]),zs,s("div",Js,[Qs,Hs,s("pre",$s,[s("code",null,[sa,a(`
