...
`),s("span",K,[G,s("span",L,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),Y,a(`
`),W,a(`
...
`),Gs,a(`
`),Ls,a(`
`),s("span",Ys,[Ws,s("span",Xs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),zs,a(`
`),Zs])])]),Qs,s("div",js,[Hs,Js,s("pre",$s,[s("code",null,[sa,a(`
