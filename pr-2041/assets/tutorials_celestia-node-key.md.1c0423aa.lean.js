...
`),Gs,a(`
`),Ws,a(`
`),s("span",Ls,[Ks,s("span",Xs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),zs])])]),Js,s("div",js,[Hs,Qs,s("pre",$s,[s("code",null,[sa,a(`
