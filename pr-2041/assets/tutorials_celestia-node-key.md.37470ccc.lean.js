...
`),s("span",K,[W,s("span",Y,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),L,a(`
`),Z])]),s("pre",z,[s("code",null,[H,a(`
`),s("span",J,[Q,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Ws,a(`
`),Ys,a(`
`),s("span",Gs,[Ls,s("span",Zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),zs,a(`
`),Hs])])]),Js,s("div",Qs,[js,Xs,s("pre",$s,[s("code",null,[sa,a(`
