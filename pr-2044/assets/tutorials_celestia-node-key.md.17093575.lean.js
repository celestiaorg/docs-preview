...
`),I,a(`
`),q,a(`
`),V])])]),N,s("div",x,[R,M,s("pre",O,[s("code",null,[U,a(`
`),s("span",Y,[W,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),L,a(`
`),J,a(`
`),K])]),s("pre",Q,[s("code",null,[Z,a(`
`),s("span",j,[z,s("span",H,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Ws,a(`
`),Gs,a(`
`),s("span",Ls,[Js,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Qs,a(`
`),Zs])])]),js,s("div",zs,[Hs,Xs,s("pre",$s,[s("code",null,[sa,a(`
