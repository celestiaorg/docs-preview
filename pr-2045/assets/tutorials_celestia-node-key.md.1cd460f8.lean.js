...
`),s("span",Y,[Z,s("span",L,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),K,a(`
`),W])]),s("pre",J,[s("code",null,[Q,a(`
`),s("span",z,[H,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),X,a(`
`),$,a(`
...
`),Zs,a(`
`),Ls,a(`
`),s("span",Gs,[Ks,s("span",Ws,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Js,a(`
`),Qs])])]),zs,s("div",Hs,[js,Xs,s("pre",$s,[s("code",null,[sa,a(`
