...
`),L,a(`
`),W,a(`
`),H])]),s("pre",j,[s("code",null,[J,a(`
`),s("span",Z,[X,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),Q,a(`
`),$,a(`
...
`),Gs,a(`
`),Ks,a(`
`),s("span",Ls,[Ws,s("span",Hs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),js,a(`
`),Js])])]),Zs,s("div",Xs,[zs,Qs,s("pre",$s,[s("code",null,[sa,a(`
