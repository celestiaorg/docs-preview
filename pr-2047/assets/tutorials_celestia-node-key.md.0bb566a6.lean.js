...
`),s("span",Y,[L,s("span",W,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),K,a(`
`),H])]),s("pre",Z,[s("code",null,[z,a(`
...
`),Ls,a(`
`),Ws,a(`
`),s("span",Gs,[Ks,s("span",Hs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),zs])])]),Js,s("div",Qs,[js,Xs,s("pre",$s,[s("code",null,[sa,a(`
