...
`),s("span",Y,[W,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),Z,a(`
`),L,a(`
`),K])]),s("pre",z,[s("code",null,[X,a(`
...
`),Ws,a(`
`),Gs,a(`
`),s("span",Zs,[Ls,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),zs,a(`
`),Xs])])]),Js,s("div",js,[Qs,Hs,s("pre",$s,[s("code",null,[sa,a(`
