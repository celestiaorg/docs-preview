...
`),s("span",Y,[G,s("span",z,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),W,a(`
`),L,a(`
`),K])]),s("pre",Q,[s("code",null,[H,a(`
...
`),Gs,a(`
`),zs,a(`
`),s("span",Ws,[Ls,s("span",Ks,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Qs,a(`
`),Hs])])]),Js,s("div",Xs,[Zs,js,s("pre",$s,[s("code",null,[sa,a(`
