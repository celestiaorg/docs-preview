...
`),Ys,a(`
`),Ws,a(`
`),s("span",Ls,[Ks,s("span",js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),zs,a(`
`),Hs])])]),Zs,s("div",Js,[Qs,Xs,s("pre",$s,[s("code",null,[sa,a(`
