...
`),s("span",Y,[L,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),W,a(`
`),K,a(`
`),X])]),s("pre",j,[s("code",null,[J,a(`
`),s("span",Z,[z,s("span",Q,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Ls,a(`
`),Gs,a(`
`),s("span",Ws,[Ks,s("span",Xs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),js,a(`
`),Js])])]),Zs,s("div",zs,[Qs,Hs,s("pre",$s,[s("code",null,[sa,a(`
