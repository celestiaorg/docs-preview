...
`),s("span",Y,[W,s("span",K,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),L,a(`
`),G,a(`
`),z])]),s("pre",H,[s("code",null,[Z,a(`
...
`),Ws,a(`
`),Ks,a(`
`),s("span",Ls,[Gs,s("span",zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Hs,a(`
