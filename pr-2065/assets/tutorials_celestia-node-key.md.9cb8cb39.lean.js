...
`),s("span",L,[Y,s("span",G,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),K,a(`
`),W,a(`
`),z])]),s("pre",Z,[s("code",null,[J,a(`
...
`),Ys,a(`
`),Gs,a(`
`),s("span",Ks,[Ws,s("span",zs,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),Js])])]),js,s("div",Hs,[Xs,Qs,s("pre",$s,[s("code",null,[sa,a(`
