...
`),s("span",W,[Y,s("span",L,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),K,a(`
`),J])]),s("pre",Q,[s("code",null,[X,a(`
`),s("span",Z,[z,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),H,a(`
`),$,a(`
...
`),Ys,a(`
`),Ls,a(`
`),s("span",Gs,[Ks,s("span",Js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Qs,a(`
`),Xs])])]),Zs,s("div",zs,[js,Hs,s("pre",$s,[s("code",null,[sa,a(`
