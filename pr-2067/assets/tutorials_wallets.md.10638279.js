...
`),k,n(`
`),I,n(`
`),P])]),s("pre",v,[s("code",null,[S,n(`
`),N,n(`
`),f,n(`
`),s("span",R,[s("span",x,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),M,n(`
`),s("span",V,[s("span",L,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
`),s("span",U,[s("span",K,"  rest: '"+l(a.constants.mainnetRestUrl)+"'",1)]),n(`
`),j,n(`
`),G,n(`
`),H])])]),s("div",O,[W,Y,s("pre",z,[s("code",null,[J,n(`
`),Z,n(`
`),X,n(`
`),s("span",Q,[s("span",$,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),ss,n(`
...
`),vs,n(`
`),s("span",Ss,[s("span",Ns,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",fs,[s("span",Rs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),xs,n(`
`),Ms,n(`
`),Vs])]),s("pre",Ls,[s("code",null,[Us,n(`
`),Ks,n(`
`),js,n(`
`),s("span",Gs,[s("span",Hs,"  chainId: '"+l(a.constants.arabicaChainId)+"',",1)]),n(`
`),Os,n(`
`),s("span",Ws,[s("span",Ys,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",zs,[s("span",Js,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Zs,n(`
`),Xs,n(`
`),Qs])])])])]),$s,s("div",sn,[nn,s("div",an,[s("div",ln,[on,pn,s("pre",en,[s("code",null,[tn,n(`
`),cn,n(`
`),rn,n(`
...
`),s("span",Pn,[s("span",vn,"  rest: '"+l(a.constants.mainnetRestUrl)+"'",1)]),n(`
`),Sn,n(`
`),Nn,n(`
`),fn])])]),s("div",Rn,[xn,Mn,s("pre",Vn,[s("code",null,[Ln,n(`
`),Un,n(`
`),Kn,n(`
`),s("span",jn,[s("span",Gn,"  chainId: '"+l(a.constants.mochaChainId)+"',",1)]),n(`
`),Hn,n(`
`),s("span",On,[s("span",Wn,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
`),s("span",Yn,[s("span",zn,"  rest: '"+l(a.constants.mochaRestUrl)+"'",1)]),n(`
`),Jn,n(`
`),Zn,n(`
`),Xn])]),s("pre",Qn,[s("code",null,[$n,n(`
`),sa,n(`
`),na,n(`
...
`),Ra,n(`
`),s("span",xa,[s("span",Ma,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",Va,[s("span",La,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Ua,n(`
`),Ka,n(`
`),ja])])])])]),Ga,Ha,Oa,Wa,Ya,s("ul",null,[s("li",null,[n("Chain Id: "),s("code",null,l(a.constants.arabicaChainId),1)]),za,s("li",null,[n("New RPC URL: "),s("code",null,"https://rpc.celestia-"+l(a.constants.arabicaChainId)+".com/",1)]),s("li",null,[n("New REST URL: "),s("code",null,"https://api.celestia-"+l(a.constants.arabicaChainId)+".com",1)]),Ja,Za,Xa,Qa,s("li",null,[n("Block explorer URL (optional): "),s("code",null,"https://explorer.celestia-"+l(a.constants.arabicaChainId)+".com",1)])]),$a])}const rl=e(r,[["render",sl]]);export{cl as __pageData,rl as default};
