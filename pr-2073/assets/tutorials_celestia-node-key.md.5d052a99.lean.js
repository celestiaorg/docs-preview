...
`),P,a(`
`),q,a(`
`),V])])]),N,s("div",R,[x,M,s("pre",O,[s("code",null,[U,a(`
`),s("span",Y,[L,s("span",K,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),G,a(`
`),W,a(`
`),J])]),s("pre",Z,[s("code",null,[Q,a(`
`),s("span",j,[H,s("span",X,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),z,a(`
`),$,a(`
...
`),Ls,a(`
`),Ks,a(`
`),s("span",Gs,[Ws,s("span",Js,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Zs,a(`
`),Qs])])]),js,s("div",Hs,[Xs,zs,s("pre",$s,[s("code",null,[sa,a(`
