...
`),j,n(`
`),G,n(`
`),O])])]),s("div",H,[W,J,s("pre",Y,[s("code",null,[X,n(`
`),Z,n(`
`),Q,n(`
...
`),Cs,n(`
`),ms,n(`
`),qs])])]),s("div",Ts,[ws,bs,s("pre",Ds,[s("code",null,[gs,n(`
`),Bs,n(`
`),ks,n(`
...
`),xs,n(`
`),Vs,n(`
`),Ms])]),s("pre",Ls,[s("code",null,[Ks,n(`
`),Us,n(`
`),js,n(`
`),s("span",Gs,[s("span",Os,"  chainId: '"+l(a.constants.arabicaChainId)+"',",1)]),n(`
`),Hs,n(`
`),s("span",Ws,[s("span",Js,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
`),s("span",Ys,[s("span",Xs,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Zs,n(`
`),Qs,n(`
...
`),On,n(`
`),s("span",Hn,[s("span",Wn,"  rpc: '"+l(a.constants.mochaRpcUrl)+"',",1)]),n(`
`),s("span",Jn,[s("span",Yn,"  rest: '"+l(a.constants.mochaRestUrl)+"'",1)]),n(`
`),Xn,n(`
`),Zn,n(`
`),Qn])]),s("pre",zn,[s("code",null,[$n,n(`
`),sa,n(`
`),na,n(`
...
`),qa,n(`
`),s("span",Ta,[s("span",wa,"  rpc: '"+l(a.constants.arabicaRpcUrl)+"',",1)]),n(`
