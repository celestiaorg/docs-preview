import{c as e}from"./chunks/constants.e9fbba9f.js";import{_ as t,o as c,c as r,O as o,k as n,t as p,a}from"./chunks/framework.83645df2.js";const E={data(){return{constants:e}}},pn=JSON.parse('{"title":"Wallet integrations with Celestia","description":"How you can add Celestia network parameters to wallets such as Keplr, Leap, and Cosmostation.","frontmatter":{"description":"How you can add Celestia network parameters to wallets such as Keplr, Leap, and Cosmostation.","head":[["meta",{"property":"og:title","content":"Wallet integrations with Celestia | Celestia Docs"}],["meta",{"property":"og:description","content":"How you can add Celestia network parameters to wallets such as Keplr, Leap, and Cosmostation."}]]},"headers":[],"relativePath":"tutorials/wallets.md","filePath":"tutorials/wallets.md","lastUpdated":1750980362000}'),i={class:"vp-code-group vp-adaptive-theme"},y={class:"blocks"},d={class:"language-js vp-adaptive-theme active"},F={class:"shiki github-dark vp-code-dark"},u={class:"line"},m={style:{color:"#9ECBFF"}},C={class:"line"},A={style:{color:"#9ECBFF"}},h={class:"line"},w={style:{color:"#9ECBFF"}},q={class:"shiki github-light vp-code-light"},b={class:"line"},g={style:{color:"#032F62"}},B={class:"line"},k={style:{color:"#032F62"}},D={class:"line"},v={style:{color:"#032F62"}},f={class:"language-js vp-adaptive-theme"},N={class:"shiki github-dark vp-code-dark"},I={class:"line"},P={style:{color:"#9ECBFF"}},x={class:"line"},R={style:{color:"#9ECBFF"}},M={class:"line"},L={style:{color:"#9ECBFF"}},S={class:"shiki github-light vp-code-light"},U={class:"line"},T={style:{color:"#032F62"}},K={class:"line"},j={style:{color:"#032F62"}},_={class:"line"},G={style:{color:"#032F62"}},H={class:"language-js vp-adaptive-theme"},V={class:"shiki github-dark vp-code-dark"},O={class:"line"},Y={style:{color:"#9ECBFF"}},W={class:"line"},Z={style:{color:"#9ECBFF"}},J={class:"line"},Q={style:{color:"#9ECBFF"}},X={class:"shiki github-light vp-code-light"},z={class:"line"},$={style:{color:"#032F62"}},ss={class:"line"},ns={style:{color:"#032F62"}},as={class:"line"},ls={style:{color:"#032F62"}},ps={class:"vp-code-group vp-adaptive-theme"},os={class:"blocks"},es={class:"language-js vp-adaptive-theme active"},ts={class:"shiki github-dark vp-code-dark"},cs={class:"line"},rs={style:{color:"#9ECBFF"}},Es={class:"line"},is={style:{color:"#9ECBFF"}},ys={class:"line"},ds={style:{color:"#9ECBFF"}},Fs={class:"shiki github-light vp-code-light"},us={class:"line"},ms={style:{color:"#032F62"}},Cs={class:"line"},As={style:{color:"#032F62"}},hs={class:"line"},ws={style:{color:"#032F62"}},qs={class:"language-js vp-adaptive-theme"},bs={class:"shiki github-dark vp-code-dark"},gs={class:"line"},Bs={style:{color:"#9ECBFF"}},ks={class:"line"},Ds={style:{color:"#9ECBFF"}},vs={class:"line"},fs={style:{color:"#9ECBFF"}},Ns={class:"shiki github-light vp-code-light"},Is={class:"line"},Ps={style:{color:"#032F62"}},xs={class:"line"},Rs={style:{color:"#032F62"}},Ms={class:"line"},Ls={style:{color:"#032F62"}},Ss={class:"language-js vp-adaptive-theme"},Us={class:"shiki github-dark vp-code-dark"},Ts={class:"line"},Ks={style:{color:"#9ECBFF"}},js={class:"line"},_s={style:{color:"#9ECBFF"}},Gs={class:"line"},Hs={style:{color:"#9ECBFF"}},Vs={class:"shiki github-light vp-code-light"},Os={class:"line"},Ys={style:{color:"#032F62"}},Ws={class:"line"},Zs={style:{color:"#032F62"}},Js={class:"line"},Qs={style:{color:"#032F62"}};function Xs(zs,s,$s,sn,l,nn){return c(),r("div",null,[s[95]||(s[95]=o(`<h1 id="wallet-integrations-with-celestia" tabindex="-1">Wallet integrations with Celestia <a class="header-anchor" href="#wallet-integrations-with-celestia" aria-label="Permalink to &quot;Wallet integrations with Celestia&quot;">​</a></h1><p>This page covers how developers can use Keplr and React to add Celestia network parameters to wallets, and how to add custom networks to Leap and Cosmostation.</p><h2 id="add-celestia-network-parameters-to-keplr-with-react" tabindex="-1">Add Celestia network parameters to Keplr with React <a class="header-anchor" href="#add-celestia-network-parameters-to-keplr-with-react" aria-label="Permalink to &quot;Add Celestia network parameters to Keplr with React&quot;">​</a></h2><p>Before we demonstrate how to export the specific parameters for Celestia&#39;s testnets, we need to create a ReactJS component that allows us to connect directly to Keplr and pass it the network parameters.</p><p>In the following code, we show how you can export a component that detects whether Keplr is installed and sets the network params for it:</p><div class="vp-code-group vp-adaptive-theme"><div class="tabs"><input type="radio" name="group-EUQkS" id="tab-mDYOtq_" checked="checked"><label for="tab-mDYOtq_">Keplr</label></div><div class="blocks"><div class="language-jsx vp-adaptive-theme active"><button title="Copy Code" class="copy"></button><span class="lang">jsx</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// @site/src/components/AddNetworkKeplr.js</span></span>
...
`)),n("span",x,[n("span",R,"  rpc: '"+p(l.constants.mochaRpcUrl)+"',",1)]),s[18]||(s[18]=a(`
...
`)),n("span",W,[n("span",Z,"  rpc: '"+p(l.constants.arabicaRpcUrl)+"',",1)]),s[32]||(s[32]=a(`
`)),n("span",J,[n("span",Q,"  rest: '"+p(l.constants.arabicaRestUrl)+"'",1)]),s[33]||(s[33]=o(`
<span class="line"><span style="color:#9ECBFF;">}\`</span><span style="color:#E1E4E8;">}</span></span>
<span class="line"></span>
...
`)),n("span",xs,[n("span",Rs,"  rpc: '"+p(l.constants.mochaRpcUrl)+"',",1)]),s[67]||(s[67]=a(`
...
`)),n("span",Ws,[n("span",Zs,"  rpc: '"+p(l.constants.arabicaRpcUrl)+"',",1)]),s[81]||(s[81]=a(`
`)),n("span",Js,[n("span",Qs,"  rest: '"+p(l.constants.arabicaRestUrl)+"'",1)]),s[82]||(s[82]=o(`
<span class="line"><span style="color:#032F62;">}\`</span><span style="color:#24292E;">}</span></span>
<span class="line"></span>
