...
### Non-archival data availability nodes (pruned)
...
> **Note**: Starting from [TODO: Add version from PR #4768], bridge nodes default to pruning mode. These are the recommended specifications for pruned nodes.
...
| Bridge node (--archival flag) | 64 GB RAM  | 32 cores    | 637 TiB NVME\* | 1 Gbps    |
...
> **Important**: To run an archival bridge node, you must use the `--archival` flag when initializing and starting the node.
