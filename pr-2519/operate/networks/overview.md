...
Celestia's [Mainnet Beta](/operate/networks/mainnet-beta) is the production network
...
| celestia-app   | [v8.0.8](https://github.com/celestiaorg/celestia-app/releases/tag/v8.0.8)   |
...
| Software       | Version                                                                  |
| -------------- | ------------------------------------------------------------------------ |
| celestia-node  | [v0.31.0-arabica](https://github.com/celestiaorg/celestia-node/releases/tag/v0.31.0-arabica) |
| celestia-app   | [v9.0.1-arabica](https://github.com/celestiaorg/celestia-app/releases/tag/v9.0.1-arabica)     |
...
| Software       | Version                                                                           |
| -------------- | --------------------------------------------------------------------------------- |
| celestia-node  | [v0.31.0-mocha](https://github.com/celestiaorg/celestia-node/releases/tag/v0.31.0-mocha) |
| celestia-app   | [v9.0.1-mocha](https://github.com/celestiaorg/celestia-app/releases/tag/v9.0.1-mocha)   |
