...
| Software       | Version                                                                  |
| -------------- | ------------------------------------------------------------------------ |
| celestia-node  | [v0.31.1-arabica](https://github.com/celestiaorg/celestia-node/releases/tag/v0.31.1-arabica) |
...
| Software       | Version                                                                           |
| -------------- | --------------------------------------------------------------------------------- |
| celestia-node  | [v0.31.1-mocha](https://github.com/celestiaorg/celestia-node/releases/tag/v0.31.1-mocha) |
| celestia-app   | [v9.0.2-mocha](https://github.com/celestiaorg/celestia-app/releases/tag/v9.0.2-mocha)   |
