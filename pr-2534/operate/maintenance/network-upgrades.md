...
### Celenium upgrade pages

Use the Celenium upgrade pages to monitor validator signaling for the v9 upgrade:

| Network        | Upgrade page                                                                    |
| -------------- | ------------------------------------------------------------------------------- |
| Mainnet Beta   | [Celenium v9 upgrade](https://celenium.io/upgrade/9?tab=signals&page=1)         |
| Mocha testnet  | [Celenium v9 upgrade](https://mocha.celenium.io/upgrade/9?tab=signals&page=1)   |
| Arabica devnet | [Celenium v9 upgrade](https://arabica.celenium.io/upgrade/9?tab=signals&page=1) |
