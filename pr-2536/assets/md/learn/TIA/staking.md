...
As of [CIP-30](https://cips.celestia.org/cip-030.html), when delegators modify their staking positions (*e.g.*, redelegate or undelegate), the distribution no longer auto-claim rewards on delegation-share changes. Instead, rewards are accrued until the user calls `MsgWithdrawDelegatorReward`.
