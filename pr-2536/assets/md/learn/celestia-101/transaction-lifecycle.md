...
![Lifecycle of a celestia-app Transaction](/docs-preview/pr-2536/img/learn/tx-lifecycle.png)
...
![DA network](/docs-preview/pr-2536/img/learn/consensus-da.png)

To enhance connectivity, the celestia-node augments the celestia-app
with a separate libp2p network, *i.e.*, the so-called *DA network*,
...
is not available, i.e., a *false positive*. This is possible since the
