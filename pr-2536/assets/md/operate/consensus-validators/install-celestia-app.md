...
<Steps>
  ### Remove any existing copy and clone the repository
  ...
  <Tabs items={['Mainnet Beta', 'Mocha', 'Arabica']}>
    <Tabs.Tab>
      ```bash
      git checkout tags/v9.0.4
      ```
    </Tabs.Tab>

    <Tabs.Tab>
      ```bash
      git checkout tags/v9.0.4-mocha
      ```
    </Tabs.Tab>

    <Tabs.Tab>
      ```bash
      git checkout tags/v9.0.4-arabica
      ```
    </Tabs.Tab>
  </Tabs>
...
* Architectures: x86\_64 (amd64), arm64
