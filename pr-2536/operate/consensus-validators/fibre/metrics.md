...
For a network-wide view on Mocha, use the community-maintained
[Valopers Fibre dashboard](https://testnet.celestia.valopers.com/fibre) to inspect
registered providers, host reachability, and validator endorsements.
