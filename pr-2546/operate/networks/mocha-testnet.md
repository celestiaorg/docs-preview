...
Account balances from a selected `mocha-4` snapshot will carry over to
`mocha-5`, but account sequences reset to 0. Existing delegations,
unbonding delegations, and pending staking rewards will become liquid
balances. The validator set, governance proposals, IBC channels, and
Hyperlane state will not carry over.
...
- `full.consensus.mocha-5.celestia-mocha.com`
- `consensus-full-mocha-5.celestia-mocha.com`
- `rpc-mocha.pops.one`
...
- `grpc-mocha.pops.one`
- `full.consensus.mocha-5.celestia-mocha.com:9090`
- `consensus-full-mocha-5.celestia-mocha.com:9090`
...
- da-bridge-mocha-5.celestia-mocha.com
- bridge-mocha-5.da.celestia-mocha.com

Bridge node 2:

- da-bridge-mocha-5-2.celestia-mocha.com
- bridge-mocha-5-2.da.celestia-mocha.com
