...
The governance square capacity on Arabica and Mocha is 128 MiB, while Mainnet
is 32 MiB. The consensus encoded-block limit is 32 MiB across all networks.
...
Full network parameters, such as [max bytes](https://github.com/celestiaorg/celestia-app/blob/v9.0.4/specs/src/parameters_v9.md?plain=1#L27),
can be found in the
