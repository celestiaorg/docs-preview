...
Prospective validators are welcome to apply to the program. The application is designed to assess a validator’s uptime performance and contributions to the Celestia ecosystem. Of the 100 total slots in Celestia’s active validator set, up to 50 will receive delegations within the program.
...
Every 6 months, the Celestia Foundation will distribute a portion of the Foundation’s total available stake to a cohort of validators who meet certain criteria, detailed below. Here is an overview of how the cohort process will work.

### Key Points

- The program is split into Cohorts every 6 months.
- Each Cohort has to renew in 6 months.
...
| -------- | ----------- | ------------------- | ----------------- |
| Cohort 9 | 35          | TBD 6 months           | TBD Cohort 10          |
| Cohort 10 | 35          | TBD 6 months           | TBD Cohort 11          |
| Cohort 11 | 35          | TBD 6 months           | TBD Cohort 12         |
| Cohort 12 | 35          | TBD 6 months           | TBD Cohort 13         |
...
- Violating the [Celestia.org Community Code of Conduct](/learn/code-of-conduct) or engaging in harmful activities towards the network
...
- [Cohort 7](https://forum.celestia.org/t/foundation-delegation-cohort-7-is-live/2232): 20 Validator Seats (Applications open February 1, 2026)
- [Cohort 8](https://forum.celestia.org/t/foundation-delegation-cohort-8-is-live/2281): 15 Validator Seats (Applications open June 1, 2026)